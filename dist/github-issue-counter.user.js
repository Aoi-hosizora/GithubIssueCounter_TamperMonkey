...
// @version      1.0.0
// @author       Aoi-hosizora
// @description  A tampermonkey plugin for showing github issue count on github repositories tab.
// @namespace    https://github.com/
// @match        http*://github.com/*
// @copyright    2020+, Aoi-hosizora

// @downloadURL  https://github.com/Aoi-hosizora/GithubIssueCounter_TamperMonkey/raw/master/dist/github-events.user.js
// @updateURL    https://github.com/Aoi-hosizora/GithubIssueCounter_TamperMonkey/raw/master/src/etc/banner.js
...
const app_1 = __webpack_require__(/*! ./ts/app */ "./src/ts/app.ts");
jquery_1.default(() => {
    app_1.onLoaded();
});
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.onLoaded = void 0;
const jquery_1 = __importDefault(__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"));
const utils_1 = __webpack_require__(/*! ./utils */ "./src/ts/utils.ts");
function onLoaded() {
    const url = utils_1.checkUrl(document.URL);
    if (!url) {
        return;
    }
    console.log(url);
...
function handleAllRepos() {
    const lines = jquery_1.default('div#user-repositories-list li div.col-10');
    if (lines.length === 0) {
        return;
    }
...
function handleEachRepo(el) {
    const aTag = jquery_1.default(el).find('a');
    if (aTag.length === 0) {
        return;
    }
    ...
    `;
    const iconTag = jquery_1.default(el).find('div.f6.text-gray a.muted-link:last-of-type');
    if (iconTag.length > 0) {
        jquery_1.default(newA).insertAfter(iconTag);
        return;
    }
    const langTag = jquery_1.default(el).find('div.f6.text-gray span.ml-0.mr-3');
    if (langTag.length > 0) {
        jquery_1.default(newA).insertAfter(langTag);
        return;
    }
    const divTag = jquery_1.default(el).find('div.f6.text-gray');
    divTag.prepend(newA);
}
